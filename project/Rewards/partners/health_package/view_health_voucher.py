...
# click on health
drive.find_element(By.XPATH,"/html/body/div[1]/div[2]/div/main/div/div[1]/div/div/div[3]/div/div/div/div[6]/div/div/div[1]").click()
time.sleep(2)

# click on select an option
drive.find_element(By.XPATH,"/html/body/div[1]/div[2]/div/main/div/div[1]/div/div/div[2]/div/div[2]/div[1]/div/div/div/div/div/div/div[1]").click()
time.sleep(2)

# click on view voucher
drive.find_element(By.XPATH,"/html/body/div[1]/div[2]/div/main/div/div[1]/div/div/div[3]/div/div/div/div[1]/div/img").click()
time.sleep(2)
