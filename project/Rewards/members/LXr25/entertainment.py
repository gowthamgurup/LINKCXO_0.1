...
element = drive.find_element(By.XPATH,"/html/body/div[1]/div[2]/div/main/div/div[1]/div/div/div/div[1]/div[3]/div[3]/div[2]")
actions = ActionChains(drive)
actions.move_to_element(element).perform()
time.sleep(5)

# click on view voucher
drive.find_element(By.XPATH,"(//div)[228]").click()
time.sleep(2)
...
#
# # click on view voucher
# drive.find_element(By.XPATH,"(//div)[242]").click()
# time.sleep(2)
#
#
# #scroll up it reach to applied section till T & C
