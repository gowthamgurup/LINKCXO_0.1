...
# click on details lxr25
drive.find_element(By.XPATH,"//body[1]/div[1]/div[2]/div[1]/main[1]/div[1]/div[1]/div[1]/div[1]/div[3]/div[1]/div[1]/div[1]/div[1]/div[1]/div[2]/div[5]/div[1]/div[2]/div[1]/button[1]").click()
time.sleep(2)

#scroll up it reach to applied section
element = drive.find_element(By.XPATH,"/html/body/div[1]/div[2]/div/main/div/div[1]/div/div/div/div[1]/div[3]/div[2]/div[2]/div[7]/div/div[1]")
actions = ActionChains(drive)
actions.move_to_element(element).perform()
time.sleep(5)

# click on view voucher
drive.find_element(By.XPATH,"(//div)[155]").click()
time.sleep(2)
...
# click on view voucher
drive.find_element(By.XPATH,"(//div)[162]").click()
time.sleep(2)
