...
# click on real eatate
drive.find_element(By.XPATH,"/html/body/div[1]/div[2]/div/main/div/div[1]/div/div/div[2]/div/div/div/button[3]/div/h5[1]").click()
time.sleep(2)

# click on select an option
drive.find_element(By.XPATH,"/html/body/div[1]/div[2]/div/main/div/div[1]/div/div/div[2]/div/div[3]/div[1]/div[2]/div/div[1]/div/img").click()
time.sleep(2)
...
# click on see all
drive.find_element(By.XPATH,"/html/body/div[1]/div[2]/div/main/div/div[1]/div/div/div[2]/div/div[3]/div[1]/div[1]/div/div/div[2]/h5").click()
time.sleep(10)

##scroll up it reach
element = drive.find_element(By.XPATH,"/html/body/div[1]/div[2]/div/main/div/div[1]/div/div/div[2]/div/div[3]/div[1]/div[2]/div/div[11]/div/img")
actions = ActionChains(drive)
actions.move_to_element(element).perform()
time.sleep(10)
