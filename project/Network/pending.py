...
# time.sleep(8)   /html/body/div[1]/div[2]/div/main/div/div/div/div/div[3]/div/div[1]/div/div/button[3]/div
...
# click on Existing
drive.find_element(By.XPATH,"(//div[@class='css-1iegyem'])[5]").click()
time.sleep(5)
...
# click on remove
drive.find_element(By.XPATH,"(//button[contains(text(),'Remove')])[1]").click()
time.sleep(10)
...
# click on pending
drive.find_element(By.XPATH,"(//div[@class='MuiBox-root css-18nr912'])[1]").click()
time.sleep(5)
