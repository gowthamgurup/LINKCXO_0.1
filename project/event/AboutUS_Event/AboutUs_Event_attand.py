...
## event attend
drive.find_element(By.CSS_SELECTOR,"li[class='react-multi-carousel-item react-multi-carousel-item--active carousel-item-padding-40-px'] button[class='btn-event-rsvp']").click()
time.sleep(2)
