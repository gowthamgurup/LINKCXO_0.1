...
class TestSample():
    ...
    def test_login(self,test_setup):
        ...
        #  Be a member
        drive.find_elements(By.XPATH,"/html/body/div/div/div[1]/div/header/div/div[3]/button/a")
        # time.sleep(2)
        ...
        time.sleep(10)
            # click on post
        st = drive.find_elements(By.XPATH,"/html/body/div[1]/div[2]/div/main/div/div[1]/div/div/div/div[3]/button[1]")
        time.sleep(10)
        if len(st) > 0:
