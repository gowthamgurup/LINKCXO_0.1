...
# click on JOB STATUS
drive.find_element(By.XPATH,"(//button[contains(text(),'Status')])[1]").click()
time.sleep(20)
...
# # to select pre data and then we can pass    : send_keys("developer") if we type means it add witha previes data
...
#
# # qualification
# qualification=drive.find_element(By.XPATH,"//body//div//div//div//main//div//div//div//div//div//div//form//div//div//div//div//div//div//input[@value='MBA,BCA,MCA,BAC,Excepe MECANICAL']")
# qualification.send_keys(Keys.CONTROL+'a')
# qualification.send_keys("BE,Btac,Mtac")
# time.sleep(2)
#
# # SKILL
# skill=drive.find_element(By.XPATH,"(//input[@type='text'])[6]")
...
#pending  bcoz attachment is not done so its pending