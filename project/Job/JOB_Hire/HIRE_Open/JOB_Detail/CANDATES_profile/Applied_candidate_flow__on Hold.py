...
##  click on  shortlist from hold section
drive.find_element(By.XPATH,"/html/body/div[1]/div[2]/div/main/div/div[1]/div[2]/div[2]/div/div[1]/div/div[2]/div[3]/div/div[2]/button").click()
time.sleep(10)




# click on hold  from shortlist
drive.find_element(By.XPATH,"/html/body/div[1]/div[2]/div/main/div/div[1]/div[2]/div[4]/div/div/div/div/div[3]/div/div[1]/button").click()
time.sleep(10)

#scroll up it reach to shortlist section
element = drive.find_element(By.XPATH,"/html/body/div[1]/div[2]/div/main/div/div[1]/div[2]/div[7]/div/div")
actions = ActionChains(drive)
actions.move_to_element(element).perform()
time.sleep(10)


# #click on rejact in hold
drive.find_element(By.XPATH,"/html/body/div[1]/div[2]/div/main/div/div[1]/div[2]/div[6]/div/div/div/div/div[3]/div/div[2]/button").click()
time.sleep(10)
...
# drive.find_element(By.XPATH,"/html/body/div[1]/div[2]/div/main/div/div[1]/div[2]/div[2]/div/div[1]/div/img").click()
# time.sleep(1)
#
#
# # switch to new window
...
#
#
# # not done  job>hire>view job >candidate on hold if we click on hold in hold section candidate is not visibal
